...
/**
 * Create plugin XML task
 *
 * This task creates the `plugin.xml` file based on the extensions set up.
 * @author jasch
 * @version 0.1.0
 * @since 0.1.0
 */
open class CreatePluginXMLTask : DefaultTask() {
    ...
    fun createPluginXML() {
        ...
        plugin.append("\n\n  <!-- Runtime libraries generated by build script -->" +
                "\n  <runtime>")
...
//            if (it.isFile && !(!myExtension.includeEclipsitoInXML && it.name.contains("eclipsito.jar"))) {
        ...
        plugin.append("\n  <!-- Extension points generated by build script -->")
        ...
        plugin.append("\n\n <!-- Extensions generated by build script -->")
